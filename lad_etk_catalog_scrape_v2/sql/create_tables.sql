DROP VIEW IF EXISTS uzc_gazes.v_get_equipment_metadata;
...
SELECT DISTINCT t.category_code, c.name AS category_name FROM uzc_gazes.technical_equipment AS t
...
SELECT DISTINCT(mark) AS mark, t.category_code
...
SELECT DISTINCT(t.model) AS model, t.mark, t.category_code
FROM uzc_gazes.technical_equipment AS t
