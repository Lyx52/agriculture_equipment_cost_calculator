        ...
        <BTableSimple hover no-border-collapse outlined caption-top  responsive class="w-100 mb-0 overflow-x-clip">
            ...
            <BThead head-variant="dark">
                <BTr>
                    ...
                    <BTh>Tehnikas izmaksas, EUR/h</BTh>
                </BTr>
            </BThead>
            <BTbody>
                <BTr v-for="row in equipmentCollectionStore.items">
                    ...
                    <BTd class="align-middle text-center">
                        {{ row.getTotalEquipmentCostValuePerHour(generalInformationStore.interestRate, generalInformationStore.taxAndInsuranceRate).toFixed(2)  }} EUR
                    </BTd>
                </BTr>
            </BTbody>
        </BTableSimple>
