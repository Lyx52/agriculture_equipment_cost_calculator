    ...
    <BButton @click="showModal = !showModal"> Attēlot grafikā (Jaunā versija) </BButton>
        <BWorkflowModal :is-spinning="chartStateStore.isLoading" v-model="showModal">
            <div class="row row-cols-2 mb-3">
                ...
                <div class="col mt-3">
                    <BInputGroup class="mt-auto" prepend="Grupēt pēc">
                        <BFormSelect
                            v-model="chartStateStore.groupBy.groupedBy"
                            @change="chartStateStore.buildChart"
                        ...
                        <template #append>
                            <BDropdown text="Dropdown with divider" auto-close="outside">
                                ...
                                <BDropdownItemButton
                                    :active="chartStateStore.groupBy.filteredValues.includes(groupedByValue)"
                                    v-for="groupedByValue in chartStateStore.getGroupedByValues"
                                    @click="chartStateStore.filterGroupedByValue(groupedByValue)"
                                >
                                    {{ groupedByValue }}
                                </BDropdownItemButton>
                            </BDropdown>
            ...
            <div class="row">
                <div class="col">
                    <div class="mt-2 d-flex flex-row gap-1">
                        ...
                        <div class="input-group" v-if="chartStateStore.selectedChartType !== 'datalabel'">
                    ...
                    <div class="mt-2 d-flex flex-row gap-1" v-for="column in chartStateStore.chartColumns">
                        ...
                        <div class="input-group" v-if="column.chartType !== 'datalabel'">
                        ...
                        <BButtonGroup>
                            ...
                            <BButton variant="success" @click="chartStateStore.downloadDataset(column.uniqueId)" v-if="chartStateStore.selectedChartType !== 'datalabel'">
